        ...
        <S title="Ablauf">
          <Steps
            items={[
              ...
              "Spielteile hinzufügen (Symbolkarte, NATO, Meldung, Koordinaten, Zahlen/Frequenzen, Buchstabieren aktiv, Uhrzeit/Datum, Funkspruch-Lückentext, Lageskizze) und je Typ konfigurieren.",
